 ...
 *******************************************************************************/
package io.senti.lwm2m.server;

import io.senti.lwm2m.server.cli.Lwm2mServerCli;
import io.senti.lwm2m.server.servlet.ClientServlet;
import io.senti.lwm2m.server.servlet.EventServlet;
import io.senti.lwm2m.server.servlet.ObjectSpecServlet;
import io.senti.lwm2m.server.servlet.ServerServlet;
...
public class Lwm2mServer {
    ...
    public static void main(String[] args) {
        ...
        // Parse command line
        Lwm2mServerCli cli = new Lwm2mServerCli();
    ...
    public static LeshanServer createLeshanServer(Lwm2mServerCli cli) throws Exception {
    ...
    private static Server createJettyServer(Lwm2mServerCli cli, LeshanServer lwServer) {
        // Now prepare Jetty
        ...
        root.setContextPath("/");
        root.setResourceBase(Lwm2mServer.class.getClassLoader().getResource("webapp").toExternalForm());
