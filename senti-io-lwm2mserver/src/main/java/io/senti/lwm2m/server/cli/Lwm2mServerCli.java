 ...
 *******************************************************************************/
package io.senti.lwm2m.server.cli;
...
/**
 * This is the class defining the Command Line Interface of Lwm2m Server.
 */
@Command(name = "lwm2m-server",
         sortOptions = false,
         description = "%n"//
                 + "@|italic " //
                 + "This is a LWM2M Server implemented with Leshan library.%n" //
...
public class Lwm2mServerCli implements Runnable {
